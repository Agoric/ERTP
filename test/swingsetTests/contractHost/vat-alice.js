    ...
    make(
      ...
      const alice = harden({
        ...
        acceptInvite(allegedInvitePaymentP) {
          ...
          const verifiedInvitePaymentP = E(allegedInvitePaymentP)
            ...
            .then(allegedInviteAmount => {
              return Promise.resolve(Promise.all([clams10P, fudco7P])).then(terms => {
        ...
        acceptOptionDirectly(allegedInvitePaymentP) {
          ...
          const verifiedInvitePaymentP = Promise.resolve(allegedInviteAmountP).then(
            allegedInviteAmount => {
              ...
              return Promise.resolve(allComparable(coveredCallTermsP)).then(terms => {
