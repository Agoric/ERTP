 ...
 * methods to assays, payments, purses, and mints. The configuration
 * also includes the function to make the  "mintKeeper" (the actual holder
 * of the mappings from purses/payments to assetDescs) and to make the
 * "descOps" (the operations on asset descriptions used for
 * depositing, minting, and otherwise manipulating erights).
...
Description must be truthy: ${description}`;
  ...
  // assetHolderSrc is a purse or payment. Return a fresh payment.  One internal
  ...
  // oldPayment rather than reducing its balance.
