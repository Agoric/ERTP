...
// transaction.
function agencyEscrow(terms, inviteMaker) {
  ...
  // that can ask the amount depositied, and then either cancel or provide an
  // escrow seat with a specific price lower than the amount.

  // Winnings and refund will be resolved if the offer is consummated. Only
  // refund if it's cancelled. Winnings will contain the item or nothing. Refund
  // contains currency.
...
const agencyEscrowSrc = `(${agencyEscrow})`;

export { agencyEscrow, agencyEscrowSrc };
